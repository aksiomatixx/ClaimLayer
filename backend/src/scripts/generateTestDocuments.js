...
const { buildPdf: buildPdfBase, fmtDate, money, MUTED } = require('./pdfWriter');

const FOOTER = 'SYNTHETIC TEST DOCUMENT — ClaimLayer demo data, not a real claim';
const buildPdf = (build) => buildPdfBase(build, FOOTER);
